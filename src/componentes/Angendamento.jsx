          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <textarea 
                ...
                className={`w-full px-4 py-3 rounded-xl border focus:outline-none focus:ring-2 focus:ring-cyan-500/20 focus:border-cyan-500 transition text-sm ${
                  erroMensagem ? 'border-rose-400 bg-rose-50/10' : 'border-slate-200'
                }`}
              ></textarea>
            ...
            <motion.button 
              ...
              whileTap={{ scale: 0.99 }}
            >
              <i className="fa-solid fa-paper-plane text-sm"></i> Enviar Solicitação
            </motion.button>
